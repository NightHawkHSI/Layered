...
class PentagonTool(_ST):
    """Regular pentagon inscribed in the drag bbox."""
    name = "Pentagon"
    ...
    def _draw(self, layer: Layer, bbox):
        ...
        pts = [
            (int(cx + rx * math.cos(math.pi * 2 * i / 5 - math.pi / 2)),
             int(cy + ry * math.sin(math.pi * 2 * i / 5 - math.pi / 2)))
            for i in range(5)
        ]
